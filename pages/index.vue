  ...
  <div>
    ...
    >
      <i18n path="trustBanner.trustLess">
        <template v-slot:link>
          <a href="https://ano2mass.cash/">{{ $t('trustBanner.link') }}</a>
        </template>
      </i18n>
    </b-notification>
    -->
    ...
    >
      <i18n path="indexNotification">
        <template v-slot:link>
          <a href="#" target="_blank" rel="noopener noreferrer">{{ $t('indexNotificationLinkText') }}</a>
        </template>
      </i18n>
    </b-notification>
    ...
    >
      <i18n path="ethLinkBanner.notification">
        ...
        <template v-slot:alternative>
          <a href="https://ano2mass.cash/">{{ $t('ethLinkBanner.alternative') }}</a>
        </template>
      </i18n>
    </b-notification>
